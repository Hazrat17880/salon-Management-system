    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 flex items-center justify-center px-4 pt-[90px] relative overflow-hidden pb-8">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <motion.button
            ...
            className={`w-full py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition ${
              isLoading || !acceptTerms ? 'opacity-80 cursor-not-allowed' : ''
            }`}
        ...
        <div className="mt-6 flex items-center justify-center space-x-4">
          <button
            type="button"
            className="flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-100 transition"
          ...
          <button
            type="button"
            className="flex items-center px-4 py-2 bg-black text-white rounded-md shadow-sm hover:opacity-90 transition"
