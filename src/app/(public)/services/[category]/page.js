...
export default function ServiceCategoryPage() {
    ...
    !service && (
      ...
      >
        <div className="text-center p-8 bg-white rounded-xl shadow-lg max-w-md mx-4">
          <h1 className="text-3xl font-bold text-rose-500 mb-4">404</h1>
          <p className="text-lg text-gray-600 mb-6">
            The service category you&apos;re looking for does not exist.
          </p>
          <Link
            href="/services"
            className="inline-block px-6 py-3 bg-rose-500 hover:bg-rose-600 text-white rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md"
          >
            <a>Browse Our Services</a>
          </Link>
        </div>
      </motion.div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-24">
      {" "}
      {/* Added pt-24 for top padding */} {/* Hero Section */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <Image
          src={service?.image ||"/images/slon.jpg"}
          alt={service?.title||"the service image"}
          fill
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-black/70 flex items-center justify-center">
          ...
          >
            ...
            >
              {service && (React.cloneElement(service?.icon, {
          ...
          >
            <div className="flex items-center mb-8">
              <div className="w-12 h-12 bg-rose-50 rounded-lg flex items-center justify-center text-rose-600 mr-4">
                {service && React.cloneElement(service.icon, { className: "w-6 h-6" })}
              </div>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="prose text-gray-600 space-y-4">
                <p>
                  Our {service?.title.toLowerCase()} services are performed by{" "}
                  {service?.expertise.toLowerCase()} using premium products to
                  ensure exceptional results. Each service begins with a
                  consultation to understand your unique needs and desired
                  outcomes.
                </p>
                <p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mb-8 text-gray-300 leading-relaxed">
                  ...
                  difference of our premium services. Our team is ready to
                  welcome you.
                </p>
  ...
  Do not just take our word for it. Here is what our clients say about their experiences.
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                quote: `The best hair color I&apos;ve ever had! The stylist listened to exactly what I wanted and delivered beyond my expectations.`,
                author: "Sarah J.",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              Join our community of satisfied clients who trust us with their
